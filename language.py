...
def buildUnigramProbs(unigrams, unigramCounts, totalCount):
    ...
    return [unigramCounts[unigram]/totalCount for unigram in unigrams ]
...
def buildBigramProbs(unigramCounts, bigramCounts):
    ...
    for key,value in bigramCounts.items():
        ...
        for key1,value1 in value.items():
            words_l.append(key1)
            prob_l.append(value1/unigramCounts[key])
        temp_dict = {"words":words_l,"probs":prob_l}
        bigram_prob[key] = temp_dict
    return bigram_prob
...
def graphTop50Words(corpus):
    ...
    barPlot(top_50_words_probs,"Top 50 words")
    return
...
def graphTopStartWords(corpus):
    ...
    start_words_probs = buildUnigramProbs(start_words,countStartWords(corpus),getCorpusLength(corpus))
    top_start_words = getTopWords(50,start_words,start_words_probs,ignore)
    barPlot(top_start_words,"Top 50 startig words")    
    return
